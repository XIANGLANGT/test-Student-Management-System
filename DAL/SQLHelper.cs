...
namespace DAL
{
    ...
    {
        //public static string connString = "Server=MSSQLSERVER2012;DataBase=[USER];Uid=sa;Pwd=[PASSWORD]";
        ...
        public static SqlDataReader GetReader(string sql)
        {
            ...
            {
                conn.Open();
                //参数CommandBehavior.CloseConnection能保证从外部关闭DataReader时，与之关联的Connection对象将随之关闭
        ...
        {
            ///select getdate()  --查询并返回数据库服务器当前的日期和时间
